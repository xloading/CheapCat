<h2>
	...
	<?php if ($model->id <> 0) {
			echo CHtml::link(
				...
				array('/admin/productcategory/update', 'id'=>$model->id),
			  	array(
			...
			echo CHtml::link(
				...
				array('/admin/productcategory/delete', 'id'=>$model->id),
			  	array(
				    'class' => 'update-dialog-open-link',
	...
	echo CHtml::link(
				...
				CHtml::normalizeUrl(array('/admin/product/create','categoryid'=>$model->id)),
			  	array(
				    'class' => 'update-dialog-open-link',
	...
	echo CHtml::link(
				...
				CHtml::normalizeUrl(array('/admin/productcategory/create','parentid'=>$model->id)),
			  	array(
				    'class' => 'update-dialog-open-link',
