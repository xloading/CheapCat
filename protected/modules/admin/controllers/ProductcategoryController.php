...
class ProductcategoryController extends CAdminController
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','ajaxfilltree','linkwithattributes'),
				'users'=>array('admin'),
			),
	 ...
	 * Manages all models.
	 */
	public function actionLinkWithAttributes()
	{
		/*$model=new Productcategory();
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Productcategory']))
		...
		if( Yii::app()->request->isAjaxRequest )
	    {
			$this->renderPartial('linkwithattrbutes',
				array(
					'model' => $model
				),
				false,
    ...
    public function actionLinkAttrs()
    {
