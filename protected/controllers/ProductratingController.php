...
class ProductratingController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Productrating');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Productrating']))
			$model->attributes=$_GET['Productrating'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='productrating-form')
		{
