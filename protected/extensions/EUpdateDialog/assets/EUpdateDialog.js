...
var updateDialog = {
  ...
  /**
   * Added by GN
   * Callback when category update was successful.
   */
  successcategoryCallback : function() {
	  if( typeof updateDialog.categoryDivUrl !== 'undefined' )
	  {
		  $('#content').load(updateDialog.categoryDivUrl);
	  }
