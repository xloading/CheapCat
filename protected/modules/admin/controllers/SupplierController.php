...
class SupplierController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','adminproductsbysupplier'),
				'users'=>array('admin'),
			),
			...
			if($model->save()){
				if( Yii::app()->request->isAjaxRequest )
				{
					...
					echo CJSON::encode( array(
				    	'status' => 'success',
						'content' => 'Supplier successfully created',
					));
					exit;
				}
				else
	...
	/**
	 * Links products to supplier
	 */
	public function actionAdminProductsBySupplier()
	{
		if( Yii::app()->request->isAjaxRequest )
		{
			...
			$this->renderPartial( '_supplierlist', array(
				'models' => $models ), false, true );
		}
	}
}
